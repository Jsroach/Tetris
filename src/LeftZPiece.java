 ...
 * 
 * @author Jack Roach
 * subclass of Piece that creates the Z shaped tetris piece
 */
public class LeftZPiece extends Piece{
	TetrisSquare[] squares = new TetrisSquare[4];

	LeftZPiece(TetrisBoard board) {
		super(board);
		squares[0] = new TetrisSquare(board);
		squares[0].moveToTetrisLocation(TetrisBoard.X_DIM_SQUARES/2, 3);
		squares[0].setColor(Color.DEEPPINK);
		...
		squares[1].setColor(Color.DEEPPINK);
		...
		squares[2].setColor(Color.DEEPPINK);
		...
		squares[3].setColor(Color.DEEPPINK);
